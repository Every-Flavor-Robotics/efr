...
$PLUGIN_SUBDIR = "efr-plugins/efr-gh"  # The subfolder with setup.py
$TMP_DIR = New-Item -ItemType Directory -Path (Join-Path $env:TEMP (New-Guid))

Write-Host "==> Installing efr-gh plugin from $PLUGIN_REPO/$PLUGIN_SUBDIR"
...
Write-Host "==> Plugin efr-gh successfully installed!"
