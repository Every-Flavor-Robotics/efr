...
$PLUGIN_REPO = "https://github.com/Every-Flavor-Robotics/efr.git"
$PLUGIN_SUBDIR = "efr-plugins/efr-motorgo"  # The subfolder with setup.py
$TMP_DIR = New-Item -ItemType Directory -Path (Join-Path $env:TEMP (New-Guid))

Write-Host "==> Installing efr-motorgo plugin from $PLUGIN_REPO/$PLUGIN_SUBDIR"
...
Write-Host "==> Plugin efr-motorgo successfully installed!"
